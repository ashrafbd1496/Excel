...
### মিক্সড ডেটা থেকে টেক্সট ও নম্বর আলাদা করার সহজ নিয়ম:
	...
	- কিবোর্ড থেকে Ctrl + G চাপুন, এতে Go To উইন্ডোটি ওপেন হবে।
 নিচের দিকে থাকা Special... অপশনে ক্লিক করুন এবং সেখান থেকে Constants বেছে নিন।

 	- এবার শুধু Text বক্সে টিক চিহ্ন দিন এবং বাকি অপশনগুলোর টিক
   তুলে দিন (Uncheck করুন)। এরপর OK চাপুন।

  	- এখন কিবোর্ড থেকে Ctrl + C চেপে কপি করুন এবং নতুন যে সেলে টেক্সটগুলো রাখতে চান, সেখানে গিয়ে পেস্ট করুন। 
  
  	- শুধু টেক্সটগুলো আলাদা হয়ে বসে যাবে।
  
 একইভাবে শুধু নম্বরগুলো আলাদা করতে চাইলে, 
 কনস্ট্যান্টস অপশনে গিয়ে বাকিগুলো আনচেক করে কেবল Numbers বক্সে
  টিক দিয়ে কপি-পেস্ট করুন।
